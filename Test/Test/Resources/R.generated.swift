...
struct R: Rswift.Validatable {
  ...
  struct image {
    /// Image `Simform`.
    static let simform = Rswift.ImageResource(bundle: R.hostingBundle, name: "Simform")

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "Simform", bundle: ..., traitCollection: ...)`
    static func simform(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.simform, compatibleWith: traitCollection)
    }
    #endif
